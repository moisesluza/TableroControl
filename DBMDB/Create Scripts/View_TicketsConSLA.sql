...
SELECT TOP 100 PERCENT 
	...
	isnull(h.first_name,'') + ' ' + isnull(h.last_name,'') AS Analista, b.last_name AS Grupo, m.first_name + ' ' + m.last_name AS Reportado_Por, 
	a.sla_violation AS SLATResolución, 
	j.sym AS Categoría, 
	j.description AS DescCat, 
	r.last_name AS GrupoCat, 
	...
	CASE a.sla_violation WHEN 0 THEN 'SLA CUMPLIDO' ELSE 'SLA INCUMPLIDO' END AS [Nivel de Servicio], 
