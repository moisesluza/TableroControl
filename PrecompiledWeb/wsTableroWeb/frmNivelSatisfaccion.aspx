<%@ page language="C#" masterpagefile="~/frmPlantilla.master" autoeventwireup="true" inherits="frmNivelSatisfaccion, App_Web_frmnivelsatisfaccion.aspx.cdcab7d2" title="Reporte de Niveles de Satisfacción" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
    
<asp:Content ID="Content1" ContentPlaceHolderID="cphMaster" Runat="Server">
    <h1>Análisis de Nivel de Satisfacción</h1>
    <hr />
    <table class="nostyle">
        <tbody>
            <tr>
